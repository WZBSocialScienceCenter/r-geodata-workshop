...
- variables:<br>
    `STATUS1`: Unemployment rate 2016 in percent<br>
...
- variables:<br>
    `sex`: `F` means unemployment rate for women, `M` for men, `T` for both<br>
    `nuts`: NUTS level-2 region code<br>
    `year`: year when the data was collected<br>
